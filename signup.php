...
<body class="index-page" style="background-color: #F6F9FF">
  ...
  <div class="card shadow-lg">
    <div class="row align-items-center text-center">
      <div class="col-md-12">
        <div class="card-body">
          <h4 class="mb-3 f-w-400 mb-5">Signup</h4>
          <form action="controller/proses_register.php" method="POST">
            ...
            <button class="btn btn-block btn-primary mb-4 w-100" style="background-color: #012970">Signup</button>
          </form>
          <p class="mb-0 text-muted">Have an account? <a href="signin.php" class="f-w-400">Signin</a></p>
        </div>
      </div>
    </div>
  </div>
